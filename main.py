...
print("l0 = %.5f" % l0)
phi_accretion = 360 * grad_to_rad * 1.01 * a_portion  # полный круг для наложения. на карте были пробелы
...
def check_if_intersect(origin_phi, origin_theta, direction_vector):
