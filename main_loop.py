...
if __name__ == '__main__':
    ...
    a_portion = [0.11, 0.22, 0.33, 0.44, 0.55, 0.66, 0.77]
    a_portion = [0.22, 0.44, 0.66]
    a_portion = [0.22]
    # a_portion = [0.165, 0.275, 0.385, 0.5, 0.605, 0.715, 0.825]
    # a_portion = [0.22, 0.44, 0.66]

    mc2 = np.linspace(10, 130, 13)
    mc2 = list(map(int, mc2))

    mc2 = [10, 30, 60, 80, 100, 130, 160]
    a_portion = [0.33, 0.55, 0.77]
    i_angle = [60]
    betta_mu = [20, 60]
    # betta_mu = [20, 40, 60]
    # mc2 = [100]
    ...
    for i_angle_index in range(len(i_angle)):
        for betta_mu_index in range(len(betta_mu)):
            condition = ((i_angle[i_angle_index] in [20, 40, 60]) and (betta_mu[betta_mu_index] in [20, 40, 60]))
            condition = False
            if condition:
                pass
            else:
                for i in range(len(mc2)):
                    for j in range(len(a_portion)):
                        for k in range(len(fi_0)):
                            ...
                            time_integral_distribution = time.perf_counter()
                            ...
                            time_integral_distribution_in_range = time.perf_counter()
                            ...
                            time_calculate_nu_L_nu_on_energy = time.perf_counter()
